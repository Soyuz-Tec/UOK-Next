...
SELECT format(
  'CREATE ROLE uok_app LOGIN NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT NOBYPASSRLS NOREPLICATION CONNECTION LIMIT 20 PASSWORD %L',
  :'app_password'
)
...
SELECT format(
  'ALTER ROLE uok_app LOGIN NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT NOBYPASSRLS NOREPLICATION CONNECTION LIMIT 20 PASSWORD %L',
  :'app_password'
)
\gexec
