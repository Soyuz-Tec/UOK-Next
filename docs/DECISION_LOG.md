...
| [0021](adr/0021-source-bound-shipment-readiness-gate.md) | One approved proposal can open a source-derived, evidence-bound GO/HOLD gate without shipment or downstream execution | Accepted | Checklist automation, shipment planning, booking, dispatch, inventory, finance, or external delivery |
